...
const Navbar = () => {
  ...
  return (
    ...
    py-3 px-4 sm:px-20 xl:px-32'>
        ...
        <button className='flex items-center gap-2 rounded-full text-sm cursor-pointer bg-primary text-white px-10 py-2.5'>Get Started <ArrowRight className='w-4 h-3'/></button>
    </div>
  )
}
